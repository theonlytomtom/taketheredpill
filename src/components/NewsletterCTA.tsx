...
export default function NewsletterCTA() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // TODO: Replace with Beehiiv embed / API call
    // Example: POST to Beehiiv subscribe endpoint
    // fetch('https://api.beehiiv.com/...', { method: 'POST', body: JSON.stringify({ email }) })
    //   .then(() => setStatus('success'))
    //   .catch(() => setStatus('error'))

    // Placeholder success for dev
    setTimeout(() => {
      setStatus('success')
      setEmail('')
    }, 800)
  ...
  return (
    ...
    >
      ...
      >
        One dispatch per week. No fluff. No sponsors. Unfiltered intelligence on military
        medicine, defense tech, and the systems that shape national health.
      </p>
